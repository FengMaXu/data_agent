...
export const DataAgentCommandSchema = Type.Union([RuntimeProbeCommandSchema, TaskCreateCommandSchema, TaskListCommandSchema, TaskRenameCommandSchema, TaskDeleteCommandSchema, SessionCreateCommandSchema, SessionListCommandSchema, SessionRenameCommandSchema, SessionDeleteCommandSchema]);
...
export const DataAgentResponseSchema = Type.Union([RuntimeProbeResponseSchema, MutationResponseSchema, ListResponseSchema]);
...
export const DataAgentEventSchema = Type.Union([Type.Object({ type: Type.Literal("runtime.probe.completed"), service: Type.Literal("data-agent-runtime") })]);
